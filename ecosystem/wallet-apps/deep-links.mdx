...
This page provides an overview approaches for interaction with wallets for external services and agents.
...
#### TON transfer to address with amount:
...
#### TON transfer to address with text comment:
...
#### Address with amount and text comment:
...
USDT decimals is 6. This means one unit equal 1000000 in amount.
